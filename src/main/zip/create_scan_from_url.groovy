...
String scanUrl = props.notNull("scanUrl")
...
try {
    ...
    println("Executing scan \"${scanName}\" on \"${scanUrl}\"")
    println("See: ${wieConsoleUrl}")

    long startTime = new Date().getTime();
    wieClient.debug("Start UNIX time is: ${startTime}")
    scanId = wieClient.createScanFromUrl(scanName, scanSiteId, scanPolicyId, scanSensorId, scanUrl, Integer.valueOf(scanPriority))
